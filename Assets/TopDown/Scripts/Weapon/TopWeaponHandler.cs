...
public class TopWeaponHandler : MonoBehaviour
{
    [Header("Attack Info")]
    ...
    public TopBaseController Controller { get; private set; } // 이 무기를 사용하는 캐릭터 컨트롤러
    ...
    {
        Controller = GetComponentInParent<TopBaseController>();
    ...
    public virtual void Attack()
    {
        ...
        if (attackSoundClip != null)
            TopSoundManager.PlayClip(attackSoundClip);
    }
